...
#define ICM20689_FAST_SAMPLING 1
#else
#define ICM20689_FAST_SAMPLING 0
#endif
...
#define ICM20689_SAMPLE_SIZE 12
#define ICM20689_MAX_FIFO_SAMPLES 3
#define MAX_DATA_READ (ICM20689_MAX_FIFO_SAMPLES * ICM20689_SAMPLE_SIZE)

class AP_ICM20689_BusDriver
{
public:
    virtual ~AP_ICM20689_BusDriver() { };
...
{
public:
    AP_InertialSensor_ICM20689(AP_InertialSensor &imu, AP_ICM20689_BusDriver *bus);
    ~AP_InertialSensor_ICM20689();
...
class AP_ICM20689_BusDriver_SPI : public AP_ICM20689_BusDriver
{
public:
    AP_ICM20689_BusDriver_SPI(void);
...
class AP_ICM20689_BusDriver_I2C : public AP_ICM20689_BusDriver
{
public:
    AP_ICM20689_BusDriver_I2C(AP_HAL::I2CDriver *i2c, uint8_t addr);
    void init(bool &fifo_mode, uint8_t &max_samples);
    void read8(uint8_t reg, uint8_t *val);
    void write8(uint8_t reg, uint8_t val);
    void set_bus_speed(AP_HAL::SPIDeviceDriver::bus_speed speed);
