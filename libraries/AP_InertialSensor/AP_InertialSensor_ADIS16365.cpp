...
// ADIS16365 accelerometer scaling for 16g range
#define ADIS16365_ACCEL_SCALE_1G    (GRAVITY_MSS / 2048.0f)
...
// MPU6000 & ADIS16365 registers
// not sure if present in ADIS16365
...
#define MPUREG_WHOAMI_ADIS16365                           0x71
#define MPUREG_WHOAMI_MPU9255                           0x73


// Configuration bits MPU 3000, MPU 6000 and ADIS16365
...
bool AP_InertialSensor_ADIS16365::_init_sensor(void)
{
    ...
    _product_id = AP_PRODUCT_ID_ADIS16365;
...
{
    uint8_t tx[4] = {reg, (uint8_t)(val&0xFF), (uint8_t)(reg+1), (uint8_t)(val>>8)};
    uint8_t rx[4];
