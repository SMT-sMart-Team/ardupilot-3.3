...
const AP_Param::Info Copter::var_info[] PROGMEM = {
    ...
    // @User: Standard
    GSCALAR(failsafe_gcs, "FS_GCS_ENABLE", 0),
    ...
    // @User: Standard
    GSCALAR(wp_yaw_behavior,  "WP_YAW_BEHAVIOR",    WP_YAW_BEHAVIOR_NONE),
    ...
    GSCALAR(log_bitmask,    "LOG_BITMASK",          393214),
    ...
    // @User: Advanced
    GSCALAR(fs_ekf_action, "FS_EKF_ACTION",    2 /*FS_EKF_ACTION_DEFAULT*/ ),
